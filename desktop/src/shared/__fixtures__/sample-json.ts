/** Payloads shaped like real API-Football responses, trimmed to what LineupLab reads. */
  ...
  response: [
    {
      ...
      teams: {
        ...
        away: { id: 40, name: 'Northgate City', logo: null, winner: false },
      },
      goals: { home: 2, away: 1 },
    ...
    },
    {
      ...
      league: { id: 1, name: 'World Cup', country: 'World', logo: null, flag: null, season: 2026, round: 'Group Stage - 1' },
      teams: {
        home: { id: 6, name: 'Brazil', logo: null, winner: null, national: true },
        away: { id: 2, name: 'France', logo: null, winner: null, national: true },
      },
...
export const lineupsPayload = {
  ...
  response: [
    ...
    {
      team: { id: 40, name: 'Northgate City', logo: null },
      coach: { id: 19, name: 'P. Novak', photo: null },
      formation: '4-2-3-1',
      startXI: [{ player: { id: 21, name: 'Nils Berger', number: 1, pos: 'G', grid: '1:1' } }],
      substitutes: [],
    },
  ],
};

export const fixturePlayersPayload = {
  ...
  response: [
    {
      ...
      statistics: [
        ...
        {
          team: { id: 33, name: 'Riverside United', logo: null },
          league: { id: 2, name: 'Champions League', country: 'World', season: 2026 },
...
export const rateLimitErrorPayload = {
  get: 'fixtures',
  parameters: [],
